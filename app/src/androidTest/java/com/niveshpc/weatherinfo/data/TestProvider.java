...
import com.niveshpc.weatherinfo.data.WeatherContract.LocationEntry;
import com.niveshpc.weatherinfo.data.WeatherContract.WeatherEntry;
...
public class TestProvider extends AndroidTestCase {
    ...
    public void testUpdateLocation() {
        ...
        //I have registered contentobserver on contentresolver instead of locationcursor(as was given in tutorial)
      //  locationCursor.registerContentObserver(tco);
        getContext().getContentResolver().registerContentObserver(locationUri,true,tco);
